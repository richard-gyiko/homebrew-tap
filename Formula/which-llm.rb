class WhichLlm < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/richard-gyiko/which-llm/releases/download/cli/v0.5.0/which-llm-aarch64-apple-darwin.tar.gz"
      sha256 "3a2545787394cdd90b8b08636dfda614b390be66ffbec80c069130eaedf0db74"
    else
      url "https://github.com/richard-gyiko/which-llm/releases/download/cli/v0.5.0/which-llm-x86_64-apple-darwin.tar.gz"
      sha256 "d204d8759f026969fc3cfb611f74505dfaa34412dc35205891b5dbd0722100f6"
    end
  end

  on_linux do
    url "https://github.com/richard-gyiko/which-llm/releases/download/cli/v0.5.0/which-llm-x86_64-unknown-linux-gnu.tar.gz"
